...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	} else if function == "changePhone" {
		return s.changePhone(APIstub, args)
...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	users := []User{
		User{FirstName: "Kim", LastName: "Sanghyuk", Email: "a53051045@gmail.com", Phone: "01023541045"},
	}
...
func (s *SmartContract) createUser(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var user = User{FirstName: args[1], LastName: args[2], Email: args[3], Phone: args[4]}
...
func (s *SmartContract) changePhone(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
